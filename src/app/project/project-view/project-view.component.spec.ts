...
it('should return ProjectView details', () =>
{
  ...
  expect(2).toBe(component.projectViews.length);
  expect("Project 1").toBe(component.projectViews[0].projectName);
  expect(4).toBe(component.projectViews[0].numberOfTasks);
  expect(2).toBe(component.projectViews[0].completedTasks);
});  
